...
rqlite servesa built-in console app, making it more convenient to manage a rqlite deployment. The console app is available at `[http://localhost:4001/console]` by default. If you are running your rqlite node on a different hostname (and perhaps port) adjust the address accordindly.
