...
<table>
	...
	<tr>
		<td><pre>--http-allow-origin</pre></td>
		<td></td>
	...
	<tr>
		<td><pre>--http-verify-client</pre></td>
		<td>false</td>
	...
	<tr>
		<td><pre>--node-verify-client</pre></td>
		<td>false</td>
	...
	<tr>
		<td><pre>--node-verify-server-name</pre></td>
		<td></td>
	...
	<tr>
		<td><pre>--bootstrap-expect</pre></td>
		<td>0</td>
	...
	<tr>
		<td><pre>--bootstrap-expect-timeout</pre></td>
		<td>120s</td>
	...
	<tr>
		<td><pre>--auto-optimize-int</pre></td>
		<td>24h</td>
	...
	<tr>
		<td><pre>--raft-snap-wal-size</pre></td>
		<td>4194304</td>
	...
	<tr>
		<td><pre>--raft-leader-lease-timeout</pre></td>
		<td>0s</td>
		<td>Leader lease timeout. Use 0s for Raft default</td>
		<td></td>
	</tr>
	<tr>
		<td><pre>--raft-timeout</pre></td>
		<td>1s</td>
	...
	<tr>
		<td><pre>--raft-election-timeout</pre></td>
		<td>1s</td>
	...
	<tr>
		<td><pre>--raft-apply-timeout</pre></td>
		<td>10s</td>
		<td>Log-apply timeout</td>
		<td></td>
	</tr>
	<tr>
		<td><pre>--raft-remove-shutdown</pre></td>
		<td>false</td>
		<td>Shutdown Raft if the node is removed from the cluster</td>
		<td></td>
	</tr>
	<tr>
		<td><pre>--raft-cluster-remove-shutdown</pre></td>
		<td>false</td>
		<td>Node removes itself from the cluster on shutdown</td>
		<td></td>
	</tr>
	<tr>
		<td><pre>--raft-shutdown-stepdown</pre></td>
		<td>true</td>
	...
	<tr>
		<td><pre>--raft-reap-node-timeout</pre></td>
		<td>0h</td>
	...
	<tr>
		<td><pre>--raft-reap-read-only-node-timeout</pre></td>
		<td>0h</td>
